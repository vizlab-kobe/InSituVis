...
C
      PARAMETER (MDIM=50, KDIM=500, MKDIM=MDIM*KDIM, IDIM=700, LSYM=16,
     1           NPAR=3, NPIDIM=IDIM*NPAR, NPC=5, NPCP2=NPC+2, MAXTP=3,
     2           NTR=MAXTP-1, NKTDIM=NTR*NPCP2*KDIM, MAXSP=10, MAXTB=10,
...
C
  ...
  690 FORMAT (6X,'Error...more than 3_ reactants...')
  700 FORMAT (6X,'Error...more than 3_ products...')
