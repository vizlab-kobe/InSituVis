...
private:
    ...
    std::vector<kvs::Vector3f> m_gradients{};
    size_t block_size;
...
public:
    ...
    // void updateFocusPoint( const kvs::ValueArray<float>& values ,const kvs::Vec3ui& dims);
...
protected:
    ...
    size_t directionIndex( const kvs::Vector3f& g );
