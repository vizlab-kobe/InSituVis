/*****************************************************************************/
/**
 *  @file   EntropyBasedCameraPathControllerMulti.h
...
class EntropyBasedCameraPathControllerMulti : public EntropyBasedCameraPathController
{
public:
...
private:
    ...
    size_t m_viewpoint_candidate_num = 1;
...
protected:
    ...
    virtual void process( const Data& data, const float radius, const kvs::Quat& rotation, const kvs::Vec3& focus, const int route_num ){}
...
#include "EntropyBasedCameraPathControllerMulti.hpp"
